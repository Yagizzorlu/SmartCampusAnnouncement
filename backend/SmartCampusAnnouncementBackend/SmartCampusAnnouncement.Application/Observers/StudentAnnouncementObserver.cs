...
public sealed class StudentAnnouncementObserver : AnnouncementObserverBase
{
    public StudentAnnouncementObserver(IUserRepository userRepository, INotificationLogRepository notificationLogRepository, INotificationChannelFactory notificationChannelFactory, IDateTimeProvider dateTimeProvider, IAppLogger logger)
        : base(userRepository, notificationLogRepository, notificationChannelFactory, dateTimeProvider, logger)
    {
    }

    public override UserType ObservedUserType => UserType.Student;
}
